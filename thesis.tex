...
% \usepackage{bibunits}
\newcites{I}{References Chapter 1}
\newcites{II}{References Chapter 2}
...
\input{chapters1/1_introduction.tex}
\input{chapters1/litreview.tex}
...
\input{chapters2/1_introduction}
\input{chapters2/2_methodology}
\input{chapters2/3_modelling}
\input{chapters2/4_results}
\input{chapters2/5_discussion}
\input{chapters2/6_conclusion}
\input{chapters2/litreview}
% \setcounter{chapter}{0}
...
\input{chapters3/introduction}
\input{chapters3/litreview}
\input{chapters3/methodology}
\input{chapters3/analysis}
\input{chapters3/discussion}
\input{chapters3/conclusion}
%%%%%%%%%%%%%%%%%%%%%%
\clearpage
